...
urlpatterns = [
    ...
    url(r'^matchinfo/report/winscores$', views.MatchWinScoreReportView.as_view()),
    url(r'^matchinfo/report/scores/table$', views.MatchScoresReportTableView.as_view()),
    url(r'^matchinfo/report/scores/details$', views.ScoreDetailsReportView.as_view()),
    url(r'^matchinfo/report/distance$', views.MatchDistanceReportView.as_view()),
    url(r'^matchinfo/report/scores/distance$', views.DistanceScoreReportView.as_view()),
    url(r'^matchinfo/report/speed$', views.MatchSpeedReportView.as_view()),
    ...
    url(r'^matchinfo/report/serve$', views.MatchServeReportView.as_view()),
